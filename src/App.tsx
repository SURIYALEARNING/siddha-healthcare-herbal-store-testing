      ...
      <div className="bg-white rounded-3xl w-full max-w-lg p-6 sm:p-8 space-y-4 border border-emerald-100 relative animate-fadeIn max-h-[90vh] overflow-y-auto">
        ...
        {success ? (
          <div className="text-center py-8 space-y-3">
            ...
            <h3 className="text-xl font-bold text-gray-800">Appointment Registered!</h3>
            <p className="text-xs text-gray-500 max-w-xs mx-auto">
              Our clinic desk will call your mobile within 24 hours to coordinate secure tele-consultation video hours with Dr. thirugnanasambandar.
            </p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="text-center">
              <span className="text-[10px] bg-siddha-light text-siddha-dark font-extrabold px-3 py-1 rounded-full uppercase tracking-wider block w-fit mx-auto">
                Vaidyar Chief Pulse Appointment
              </span>
              <h3 className="text-xl font-black text-gray-850 font-display mt-2 leading-none">Schedule Tele-Consultation</h3>
              <p className="text-xs text-slate-450 mt-1">Get authentic Siddha analysis and dietary guidelines</p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1">
                <label className="text-[10px] font-bold text-gray-450 uppercase">Your name *</label>
                <input
                  type="text"
                  placeholder="Suriyashankara Bose"
                  value={fullName}
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-bold text-gray-450 uppercase">Mobile contact *</label>
                <input
                  type="text"
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-bold text-gray-450 uppercase">Primary Health Imbalance Concern *</label>
              <select
                value={concern}
              ...
              >
                ...
                <option value="Respiratory or Cough (Kabham)">Respiratory / Severe Phlegm (Kabham)</option>
                <option value="Gastric or Acid Reflux (Pitham)">Digestive / Stomach acidities (Pitham)</option>
                <option value="Joint or muscular stiff (Vatham)">Joint stiff pains / Arthritic joint (Vatham)</option>
                <option value="Eczema, Psoriasis or Skin rashes">Skin flareups / Eczema / Psoriasis</option>
                <option value="General Immunity or booster">Energy exhaustions / Immunity booster</option>
              </select>
            </div>

            <div className="space-y-1">
              <label className="text-[10px] font-bold text-gray-450 uppercase">Describe specific physical symptoms</label>
              <textarea
                placeholder="Ex. Muscle fatigue, constant wheezing during rain transitions..."
                value={symptoms}
